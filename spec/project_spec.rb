...
describe 'Gossiping Bus Drivers' do
  ...
  context 'when two drivers meet on first bus tour' do
    context 'when all the drivers start from the same stop' do
    ...
    context 'when all the drivers do not start from the same stop' do
